...
defmodule Ex04 do
  ...
  defp even_odd([], even, odd) do
    {reverse(even), reverse(odd)}
  end
  defp even_odd([a | tail], even, odd) when Integer.is_odd(a) do
    even_odd(tail, even, [a | odd])
  end
  defp even_odd([a | tail], even, odd) do
    even_odd(tail, [a | even], odd)
  end
